 ...
 * @version $Id: BinomialTest.html 885258 2013-11-03 02:46:49Z tn $
 * @since 3.3
 */
public class BinomialTest {
     ...
     */
    public static boolean binomialTest(int numberOfTrials, int numberOfSuccesses, double probability,
   ...
   /**
     ...
     * @see AlternativeHypothesis
     */
    public static double binomialTest(int numberOfTrials, int numberOfSuccesses, double probability,
